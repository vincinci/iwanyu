    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto px-2 sm:px-4 py-4 sm:py-8">
        ...
        >
          ...
          <button
            onClick={() => navigate('/')}
            className="flex items-center gap-2 text-gray-600 hover:text-gray-900 mb-2 sm:mb-4 transition-colors text-sm sm:text-base"
          >
          ...
          {profile?.status === 'PENDING' && (
            <div className="mt-2 sm:mt-4 p-2 sm:p-4 bg-gray-50 border border-gray-200 rounded-lg">
              <div className="flex items-center gap-2">
                <Clock className="w-4 h-4 sm:w-5 sm:h-5 text-gray-600" />
                <span className="font-medium text-gray-800 text-sm sm:text-base">Application Pending</span>
              </div>
        ...
        <motion.div
          ...
          className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-6 mb-4 sm:mb-8"
        >
          <div className="bg-white p-3 sm:p-6 rounded-lg shadow-sm border">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-xs sm:text-sm font-medium text-gray-600">Total Products</p>
                <p className="text-lg sm:text-2xl font-bold text-gray-900">{dashboard?.productCount || 0}</p>
              </div>
          ...
          <div className="bg-white p-3 sm:p-6 rounded-lg shadow-sm border">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-lg sm:text-2xl font-bold text-gray-900">{dashboard?.totalOrders || 0}</p>
              </div>
          ...
          <div className="bg-white p-3 sm:p-6 rounded-lg shadow-sm border">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-lg sm:text-2xl font-bold text-gray-900">{dashboard?.totalSales || 0}</p>
              </div>
              <DollarSign className="h-6 w-6 sm:h-8 sm:w-8 text-gray-500" />
            </div>
          </div>
          <div className="bg-white p-3 sm:p-6 rounded-lg shadow-sm border">
            <div className="flex items-center justify-between">
